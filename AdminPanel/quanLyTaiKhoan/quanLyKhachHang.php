...
<body>
	<button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal" style="background-color: rgba(65,65,65,1.00)">Thêm khách hàng</button>
    ...
    <div class="modal-dialog">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form method="post" action="quanLyTaiKhoan/themTK.php?mapq=3" class="" id="frmsignup">
...
<?php
	$result=mysqli_query($con,"select tbltaikhoan.matk,user,ten,count(tblhoadon.mahd) as tongHoaDon from tbltaikhoan left join tblhoadon on tbltaikhoan.matk=tblhoadon.matk where mapq=3 and tinhtrang in (1,2,3) or mapq=3 and tinhtrang IS NULL group by user order by tongHoaDon desc");
	if(mysqli_num_rows($result) > 0)
	{
?>
	<table cellspacing="0" align="center" class="table table-hover" id="example">
		<caption>Quản lý khách hàng</caption>
		...
		<?php
			...
			<tr>
				...
				<td><?php echo $row["tongHoaDon"]; ?></td>
				<td><a href="quanLyTaiKhoan/xoaTK.php?maTK=<?php echo $row["matk"];?>&mapq=3" onclick="return confirm('Bạn có chắc chắn muốn xóa?')"><img src="../Images/giaodien/icons8-trash-can-50.png" class="imgaction"/></a></td>
			</tr>
			<?php
			}
		?>
	...
	else echo("Không có khách hàng nào");
	?>
</body>
</html>
